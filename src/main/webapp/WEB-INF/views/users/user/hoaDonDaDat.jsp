...
<body>
	 <div class="container-fluid body-table" >
        ...
        <div style="margin-top: 30px; background-color: white;">
            ...
            <h1 style="text-align: center; ">Danh sách đơn hàng đã đặt</h1>
                ...
                <tbody>
                    ...
                    <tr>
	                   ...
	                   <td style="text-align: center;">
	                        <a href="<c:url value='/hoaDon/hoaDonDaDat/${item.userName}/${item.id}' />" class="btn btn-link " style="text-align: center;">Chi tiết</a>
 ...
 function convertDate(date) {
      ...
      <script type="text/javascript">
    	...
    	function destroyOne(id) {
    		var confirmation = confirm("Bạn chắc có muốn hóa đơn đã đặt này không :<<");
   	 	 if (confirmation) {
   		 $.ajax({
   				url:'/suabot/hoadon/destroyHD/'+id,
   				type: "DELETE"
   			})
   			.then(data =>{
...
<script type="text/javascript">
	function deleteAll() {
		...
		function deleteCheckBox(data) {
			$.ajax({
	    		 url:'/suabot/hoadon/destroyAllHD',
	    		 type: 'DELETE',
