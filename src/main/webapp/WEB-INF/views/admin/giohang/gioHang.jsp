...
updateCartButton.addEventListener('click', function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            // Hiển thị thông báo dựa trên mã trạng thái
            if (response === '200') {
...
function thanhToan() {
	...
	if(totalamount === ''){
		...
		window.location.href="/suabot/admin/thanhtoan/"+totalamount+"/<%=SecurityUntil.getPrincipal().getUsername() %>" 
	}
