...
<body>
	<div class="row">
        <div class="col-md-12">
         ...
         <div class="chonsoluong">
	         ...
	         <button id="giamsl" onclick="giamsl()" style="border:  none;background-color: white"  >
	        	 <i class="fa-solid fa-arrow-left" style="margin-right: 10px;font-size: 20px"></i>
	         </button> 
	         <span id="pageNumber" style="margin-right: 5px;font-size: 20px; margin-top: 5px">1</span>
         <button id="tangsl" onclick="tangsl()" style="border:  none;background-color: white;" >
         <i class="fa-solid fa-arrow-right" style="margin-left: 10px;  font-size: 20px" ></i>
         </button>
       ...
       function addGioHang() {
    		...
    		$.ajax({
    			url:'/suabot/admin/gioHang/'+${modelProduct.id},
    			type: 'POST',
