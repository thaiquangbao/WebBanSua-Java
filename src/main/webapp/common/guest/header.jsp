...
<img style="position:absolute ;width: 150px" src="https://res.cloudinary.com/dk41ftplg/image/upload/v1700458938/Teach-Node/dd1laejnh3gvf67obnd6.png" />
	<img src="<c:url value='/template/img/header.png'/>" alt="" width="100%">
</div>
<div class="col-md-12">
	<nav class=" bg-info navbar-collapse" style="background-color: black">
		<ul class="navbar-nav nav">
			<li class="navbar-item" ><a
				href="<c:url value='/guest/trang-chu'/>" class="navbar-link">TRANG
					CHỦ</a></li>
			
			<li class="navbar-item " style="width: 130px; text-align: center;">
			    <a class="nav-link "  href="<c:url value='/guest/sanpham'/>" style="text-align: center;width: 160px">SẢN PHẨM</a>
			   
			  </li>
			
			<li class="navbar-item" style="width: 130px; text-align: center;" ><a href="#lienhe" class="navbar-link">LIÊN
					HỆ</a></li>
			<li class="navbar-item"><a href="<c:url value='/guest/trang-chu#khuyenmai'/>"style="text-align: center;width: 160px" class="navbar-link">KHUYẾN
					MÃI</a></li>
			  		
			<li class="navbar-item"><a href="<c:url value='/guest/login'/>" class="navbar-link" id="btndangnhap">ĐĂNG NHẬP</a></li>
            <li class="navbar-item"><a href="<c:url value='/guest/signup'/>" class="navbar-link" id="btndangki">ĐĂNG KÍ</a></li>
			 <li class="navbar-item" style="text-align: center;">
				<a href="/suabot/guest/giohang" class="navbar-link" id="cart-icon" style="width:100px;">
...
function navigateToProductPage(target) {
    const productPageUrl = "http://localhost:8080/suabot/guest/sanpham";
    const productAnchorUrl = "http://localhost:8080/suabot/guest/sanpham" + target;
