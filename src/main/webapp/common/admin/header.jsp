...
.manager-menu .menu.active {
  opacity: 1;
  visibility: visible;
}

.manager-menu .menu::before {
  content: "";
  width: 16px;
  height: 16px;
  background-color: #222533;
...
.manager-menu .menu .profile {
  display: flex;
  align-items: center;
  margin-bottom: 30px;
}

.manager-menu .menu .profile img {
  width: 56px;
  height: 56px;
  border-radius: 50%;
  user-select: none;
...
.manager-menu .menu .profile .info {
  margin-left: 15px;
}

.manager-menu .menu .profile .info h2 {
  color: #dadada;
  font-size: 18px;
  font-weight: 400;
  text-transform: capitalize;
...
.manager-menu .menu .profile .info p {
  color: #7d8193;
  font-size: 16px;
  font-weight: 400;
}

.manager-menu .menu .btn {
  width: 250px;
  height: 53px;
  color: #e5e5e5;
  background-color: #1a1c29;
...
.manager-menu .menu .btn img {
  width: 20px;
  margin-right: 5px;
  user-select: none;
}

.manager-menu .menu .btn:hover {
  background-color: #292c3d;
}

.manager-menu .menu ul li {
  list-style: none;
  display: flex;
  align-items: center;
  margin-bottom: 20px;
...
.manager-menu .menu ul li:last-child {
  margin: 0;
}

.manager-menu .menu ul li a {
  color: #e5e5e5;
  font-size: 16px;
  font-weight: 400;
  text-decoration: none;
	...
	<nav class=" bg-info navbar-collapse" style="background-color: black;">
		<ul class="navbar-nav nav">
			<li class="navbar-item" ><a
				href="<c:url value='/admin/trang-chu'/>" class="navbar-link">TRANG
					CHỦ</a></li>
			
			<li class="navbar-item " style="width: 130px; text-align: center;">
			    <a class="navbar-link "  href="<c:url value='/admin/sanpham'/>" style="text-align: center;width: 160px">SẢN PHẨM</a>
			   
			  </li>
			
			<li class="navbar-item" style="width: 130px; text-align: center;" >
	        <a href="#lienhe" class="navbar-link">LIÊN
						HỆ</a></li>
			<li class="navbar-item"><a href="<c:url value='/admin/trang-chu#khuyenmai'/>"style="text-align: center;width: 160px" class="navbar-link">KHUYẾN
					MÃI</a></li>
	                     ...
	                     <div class="profile">
	                        ...
	                        <ul>
	                            <li>
	                                ...
	                                <a href="/suabot/admin/General/<%=SecurityUntil.getPrincipal().getUsername() %>">Thông tin cá nhân</a>
	                              </li>
	                              <li>
	                                <img src="<c:url value='/template/img/user/shopping-cart.png'/> "/>
	                                <a href="/suabot/admin/hoaDon/hoaDonDaDat/<%=SecurityUntil.getPrincipal().getUsername() %>">Các đơn đã mua</a>
	                              </li>
	                              <li>
	                                <img src="<c:url value='/template/img/user/feedback.png '/> "/>
	                                <a href="/suabot/admin/feedback/<%=SecurityUntil.getPrincipal().getUsername() %>">Phản hồi sản phẩm</a>
	                              </li>
         ...
         <li class="navbar-item manager-menu">
	        <div class="action"onmouseover="document.querySelector('.manager-menu .menu').style.visibility = 'visible'
              document.querySelector('.manager-menu .menu').style.opacity = 1"
              onmouseout="document.querySelector('.manager-menu .menu').style.visibility = 'hidden'
              document.querySelector('.manager-menu .menu').style.opacity = 0" style="margin-top: 18px;">
	               <a class="navbar-link" >QUẢN LÝ</a>
	                 ...
	                 <div class="menu">
	                        ...
	                        <ul>
	                            <li>
	                                <img src="<c:url value='/template/img/user/user.png'/>" />
	                                <a href="/suabot/admin/users">Khách hàng</a>
	                              </li>
	                              <li>
	                                <img src="<c:url value='/template/img/user/box.png'/> "/>
	                                <a href="/suabot/admin/sanpham/listSanPham">Sản phẩm</a>
	                              </li>
	                              <li>
	                                <img src="<c:url value='/template/img/user/product.png '/> "/>
	                                <a href="/suabot/admin/sanpham/category">Loại sản phẩm</a>
	                              </li>
	                              <li>
	                                <img src="<c:url value='/template/img/user/coupon.png'/> "/>
	                                <a href="/suabot/admin/sanpham/discount">Khuyến mãi</a>
	                              </li>
	                              <li>
	                                <img src="<c:url value='/template/img/user/agreement.png'/> "/>
	                                <a href="/suabot/admin/sanpham/nhacungcap">Nhà cung cấp</a>
	                              </li>
	                              <li>
	                                <img src="<c:url value='/template/img/user/checkout.png'/> "/>
	                                <a href="/suabot/admin/donhang">Đơn hàng</a>
	                              </li>
	                             <li>
	                                <img  src="<c:url value='/template/img/user/feedback.png'/> "/>
	                                <a href="/suabot/admin/feedback">Phản hổi sản phẩm</a>
	                              </li>
	                        </ul>
	                </div>   
            </div>   
         ...
         <li class="navbar-item" style="text-align: center;">
				<a href="/suabot/admin/giohang" class="navbar-link" id="cart-icon" style="width:100px;">
...
function navigateToProductPage(target) {
    const productPageUrl = "http://localhost:8080/suabot/admin/sanpham";
    const productAnchorUrl = "http://localhost:8080/suabot/admin/sanpham" + target;
