...
@Controller(value = "sanPhamControllerUser")
public class SanPhamController {
	...
	@RequestMapping(value = "/sanpham", method = RequestMethod.GET)
	   public ModelAndView homePage(@ModelAttribute("modelProduct") ProductDTO productDTO,@ModelAttribute("modelCate") CategoryDTO categoryDTO ) {
	      ModelAndView mav = new ModelAndView("users/sanpham/sanpham");
	...
	@RequestMapping(value = "/sanpham/{tenProduct}", method = RequestMethod.GET)
