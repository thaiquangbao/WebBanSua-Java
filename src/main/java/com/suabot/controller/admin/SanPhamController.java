...
@Controller(value = "sanPhamControllerAdmin")
public class SanPhamController {
	...
	@RequestMapping(value = "/admin/sanpham", method = RequestMethod.GET)
	   public ModelAndView homePage(@ModelAttribute("modelProduct") ProductDTO productDTO,@ModelAttribute("modelCate") CategoryDTO categoryDTO ) {
	      ModelAndView mav = new ModelAndView("admin/sanpham/sanpham");
	...
	@RequestMapping(value = "/admin/sanpham/{tenProduct}", method = RequestMethod.GET)
	   public ModelAndView chiTietSanPhamPage(@ModelAttribute("modelProduct") ProductDTO productDTO,@PathVariable String tenProduct) {
	      ModelAndView mav = new ModelAndView("admin/chiTietSanPham");
